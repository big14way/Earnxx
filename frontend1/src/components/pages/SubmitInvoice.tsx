...
<div className="flex-1">
  ...
  <div className="flex gap-3 flex-wrap">
    {submissionResult.hash && (
      <a 
        href={`https://explorer-holesky.morphl2.io/tx/${submissionResult.hash}`}
        target="_blank"
...
<div className="flex items-center gap-2">
  ...
  <span className="text-sm">Live on Morph</span>
</div>
...
<div className="space-y-2">
  <div>
    ...
    <a 
      href={`https://explorer-holesky.morphl2.io/address/${contractAddresses?.VERIFICATION_MODULE}`}
      target="_blank"
      rel="noopener noreferrer"
  ...
  <div>
    ...
    <a 
      href={`https://explorer-holesky.morphl2.io/address/${contractAddresses?.PROTOCOL}`}
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-300 hover:text-blue-100 underline text-xs"
    >
