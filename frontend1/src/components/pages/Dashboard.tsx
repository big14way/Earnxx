          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4 mt-2">
                {notification.txHash && (
                  <a
                    href={`https://explorer-holesky.morphl2.io/tx/${notification.txHash}`}
                    target="_blank"
    ...
    return (
      <div className="text-center py-24 px-8">
        ...
        <p className="text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
          Unlock your EarnX Protocol dashboard with live Morph blockchain data and premium Chainlink oracle integration.
        </p>
          ...
          <div className="relative bg-white/80 backdrop-blur-xl border border-white/40 rounded-[2rem] p-8 shadow-2xl">
            ...
            <ul className="text-gray-800 space-y-4 text-left font-semibold">
              <li className="flex items-center gap-3">
                ...
                Live Chainlink price feeds from Morph testnet
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                ...
                Working Chainlink Functions verification
              </li>
              <li className="flex items-center gap-3">
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-4 flex-wrap">
          <p className="text-xl text-gray-600">Live data from EarnX Morph deployment</p>
        ...
        <p className="text-xs text-gray-400 mt-2">Network: Morph Testnet | Protocol: Live EarnX Deployment</p>
      </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-green-50 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="bg-white border border-gray-200 rounded-lg p-3">
                ...
                <a
                  href={`https://explorer-holesky.morphl2.io/address/${contracts?.PROTOCOL}`}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-3">
                ...
                <a
                  href={`https://explorer-holesky.morphl2.io/address/${contracts?.USDC}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-mono text-xs text-blue-600 hover:underline flex items-center gap-1"
                >
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-3">
                ...
                <a
                  href={`https://explorer-holesky.morphl2.io/address/${contracts?.VERIFICATION_MODULE}`}
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
          ...
          <span className="text-sm font-normal text-gray-500">Live Morph Deployment</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <a
                href={`https://explorer-holesky.morphl2.io/address/${contracts?.PRICE_MANAGER}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-green-600 hover:text-green-800"
              >
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <a
                href={`https://explorer-holesky.morphl2.io/address/${contracts?.INVESTMENT_MODULE}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-600 hover:text-purple-800"
              >
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <a
                href={`https://explorer-holesky.morphl2.io/address/${contracts?.VRF_MODULE}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-red-600 hover:text-red-800"
              >
